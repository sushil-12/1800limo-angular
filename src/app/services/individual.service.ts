...
export class IndividualService {
  ...
  loadBookings(url, keyword, startDate, endDate, useDateFilter) {
    ...
    if (url) {
      ...
      path = this.serverUrl + 'get-all-reservation' + '?from=' + startDate + '&to=' + endDate + '&search=' + keyword + '&useDateFilter=' + useDateFilter + '&current_date=' + this.current_date + '&current_time=' + this.current_time + '&v1=1';
    }
