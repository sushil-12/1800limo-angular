...
@Component({
	selector: 'app-edit-master-vehicle',
	...
	ngOnInit(): void
	{
		...
		this.adminService.getFieldsData()
			...
			).subscribe(result =>
			{
				...
				this.filteredVehicleTypes = this.vehicleTypes = this.response.data.vehicle_type;
				...
				this.oldvehicleImage[0] = ""
				this.oldvehicleImage[1] = ""
				this.oldvehicleImage[2] = ""
				this.oldvehicleImage[3] = ""
				this.oldvehicleImage[4] = ""
				this.oldvehicleImage[5] = ""
				this.oldvehicleImage[6] = ""
				this.oldvehicleImage[7] = ""
				this.oldvehicleImage[8] = ""

				this.oldvehicleImage[9] = this.response.data.rearPlateImage.image;
				this.oldvehicleImage[10] = this.response.data.windowPermitImage.image;
				this.oldvehicleImage[11] = this.response.data.windowPermit2Image.image;
				this.oldvehicleImage[12] = this.response.data.usdotPermitImage.image;
				this.oldvehicleImage[13] = this.response.data.mcImage.image;
				...
				this.adminService.getVehicleData(this.vehicleId)
					...
					).subscribe(result2 =>
					{
						...
						this.pushValuesTypeOfService(this.response2.data.typeOfService)
