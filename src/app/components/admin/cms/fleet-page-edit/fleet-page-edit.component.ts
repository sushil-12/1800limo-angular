...
@Component({
  selector: 'app-fleet-page-edit',
  templateUrl: './fleet-page-edit.component.html',
  styleUrls: ['./fleet-page-edit.component.scss']
})
export class FleetPageEditComponent implements OnInit {
  ...
  heading = 'Fleet';
	...
	*/
	saveEditValue()
	{
		...
		this.adminServices.saveStepSectionData('fleet', this.editContentForm.value)
			.pipe(
				catchError(err =>
				{
