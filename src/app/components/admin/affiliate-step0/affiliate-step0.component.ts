...
export class AffiliateStep0Component implements OnInit {
	...
	public why1800limo: Array<String> = [
		...
		"Farm-outs and travel agents earn a minimum 10% commission",
		...
		"We earn a 25% commission on each booking. We pay the charge card fee and the 10% on farm-outs and commission to travel agents",
