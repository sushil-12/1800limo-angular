...
export class AffiliateStep0Component implements OnInit {
	...
	public why1800limo: Array<String> = [
		"Enter your wholesale, all-inclusive rates for each vehicle type so travel advisors and fellow operators can easily search, compare, book and share revenue",
		"Farm-outs and travel advisors earn a minimum 10% commission",
		...
		"We earn a 25% commission on each booking. We pay the charge card fee and the 10% on farm-outs and commission to travel advisors",
