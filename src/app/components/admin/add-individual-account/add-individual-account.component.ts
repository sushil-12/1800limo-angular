...
export class AddIndividualAccountComponent implements OnInit
{
	...
	ngOnInit(): void
	{
		...
		this.addIndividualAccountForm = this.formBuilder.group({
			...
			cvc: ['', [Validators.required, Validators.pattern("^[0-9]*$"), Validators.minLength(5), Validators.maxLength(5), this.customValidator.dashValidator(), this.customValidator.plusValidator()]],
