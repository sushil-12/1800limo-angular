...
import { GroupTravelFAQ, groupTravelFaqData, GROUP_TRAVEL_CATEGORIES, groupTravelMetaData } from './group-travel-planner-data';

@Component({
  selector: 'app-group-travel-planner',
  templateUrl: './group-travel-planner.component.html',
  styleUrls: ['./group-travel-planner.component.scss']
})
export class GroupTravelPlannerComponent implements OnInit {

  faqs: GroupTravelFAQ[] = [];
  filteredFaqs: GroupTravelFAQ[] = [];
  searchQuery: string = '';
  ...
  categories = GROUP_TRAVEL_CATEGORIES;
  ...
  ngOnInit(): void {
    this.titleService.setTitle(groupTravelMetaData.title);
