...
export const PHOTO_GUIDES: Record<string, PhotoGuide> = {
  ...
  'rearPlate': {
    ...
    cameraAngle: 'doc',
    imagePath: 'assets/placeholders/rear-licence-plate.jpeg',
  ...
  'windowPermit': {
    ...
    cameraAngle: 'doc',
    imagePath: 'assets/placeholders/window-permit.jpeg',
  ...
  'windowPermit2': {
    ...
    cameraAngle: 'doc',
    imagePath: 'assets/placeholders/secretary-of-state.jpeg',
  ...
  'usdotPermit': {
    ...
    cameraAngle: 'doc',
    imagePath: 'assets/placeholders/usdot.jpeg',
  ...
  'mc': {
    ...
    angleLabel: 'Document — Flat Surface',
    cameraAngle: 'doc',
    imagePath: 'assets/placeholders/vehicle-inspection-certificate.jpg',
