...
@Component({
	selector: 'app-create-new-booking-detail',
	templateUrl: './create-new-booking-detail.component.html',
	styleUrls: ['./create-new-booking-detail.component.scss']
})
export class CreateNewBookingDetailComponent implements OnInit
{
	...
	submitForm()
	{
		...
		this.affiliateService.paymentProcessing(this.chargesForm.value)
			.pipe(
				catchError(err =>
				{
					this.spinner.hide();//hide spinner
